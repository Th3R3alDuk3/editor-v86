...
new Promise(function(resolve, reject) { 
    ...
    parrot.add_listener("serial0-output-char", function listener(char) {
        ...
        if (char === "\n") {
            ...
            if (line.endsWith("localhost login: ")) {
                parrot.serial0_send_line("root");
            } else if (line.endsWith("Password: ")) {
                parrot.serial0_send_line("toor");                
            } else if (line.endsWith("localhost:~# ")) {
...
_button.onclick = function() {
    ...
    switch(_select.selectedIndex) {
        ...
        case 2: // python
            parrot.serial0_send_line("python3 ./out");
            break;
